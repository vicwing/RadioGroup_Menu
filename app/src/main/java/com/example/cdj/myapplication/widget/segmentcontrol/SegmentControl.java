...
//        mBackgroundDrawable.setStrokeColor(mColors.getDefaultColor());
        mBackgroundDrawable.setStrokeColor(defaultTextColor);
...
//                    mPaint.setColor(0xFFFFFFFF);
                    mPaint.setColor(selctedTextColor);
                }else{
//                    mPaint.setColor(mColors.getDefaultColor());
                    mPaint.setColor(defaultTextColor);
                }
//
    ...
    private int strokeColor=0xFFFFFFFF;//分割线的颜色
    private  int selctedTextColor = Color.BLACK;

    /**
     * 选中的 字体的颜色;
     * @param color
     */
    public void setSelectdTextColor(int color){
        this.selctedTextColor =color;
    }

    private int selectedDrawableColor;//选中的时的底色
    //选中时的底色
    public void setSelectedDrawableColor(int selectedDrawableColor){
        this .selectedDrawableColor = selectedDrawableColor;
        if(mSelectedDrawable != null){
            mSelectedDrawable.setColor(selectedDrawableColor);
        }
    }

    public  void setBackgroundDrawableColor(int color){
        if(mBackgroundDrawable != null){
//            mBackgroundDrawable.setStrokeColor(color);
