 ...
 */
package com.sunfusheng.StickyHeaderListView.base.quick;
...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setTextSpannable(int viewId, Spannable value) {
        TextView view = retrieveView(viewId);
        view.setText(value);
        return this;
    }
    
    public BaseAdapterHelper setTextSpannable(int viewId, CharSequence value) {
        TextView view = retrieveView(viewId);
        view.setText(value);
        return this;
    }
...
//    public BaseAdapterHelper setImageUrl_ImageLoader(int viewId, String imageUrl) {
//        ImageLoader mImageLoader = ImageLoader.getInstance();
//        DisplayImageOptions options = new DisplayImageOptions.Builder()
//                .showImageOnLoading(R.drawable.qf_list_default_pic)
//                .showImageForEmptyUri(R.drawable.qf_list_default_pic)
//                .showImageOnFail(R.drawable.qf_list_default_pic)
//                .cacheInMemory(true).cacheOnDisk(true).build();
//        ImageView view = retrieveView(viewId);
//        mImageLoader.displayImage(imageUrl, view, options);
//
//        return this;
//    }
