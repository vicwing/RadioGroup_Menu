...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    public TagView getTagView(int position){
        return mChildViews==null?null:((TagView)mChildViews.get(position));
    }
    /**
    ...
    public void setChildHeight(Context context , int height){
        mChildHeight  = (int) dp2px(context,height);
        onSetTag();
    }
}
