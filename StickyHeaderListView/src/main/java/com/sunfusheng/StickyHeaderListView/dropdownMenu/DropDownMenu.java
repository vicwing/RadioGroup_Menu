package com.sunfusheng.StickyHeaderListView.dropdownMenu;
...
//        popupMenuViews.setTag(stickyTag);
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews) {
        ...
        popupMenuViews = new FrameLayout(getContext());
//        popupMenuViews.setTag(stickyTag);
//        popupMenuViews.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        popupMenuViews.setVisibility(GONE);
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mDropDownMenuListener!=null)
                    mDropDownMenuListener.onClickListener(v);
            }
        });
    ...
    private void switchMenu(View target) {
        System.out.println("current_tab_position "+current_tab_position);
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
...
//                        popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.dd_menu_in));
                        popupMenuViews.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.dd_menu_in));
                        maskView.setVisibility(VISIBLE);
//                        maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.dd_mask_in));
                        maskView.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.dd_mask_in));
...
//        LogUtils.d("on messure.................");
//    }

    public View getTabMenuView(){
        return  tabMenuView;
    }
    private DropDownMenuListener mDropDownMenuListener;

    public interface DropDownMenuListener {
        void onClickListener(View v);
    }

    public void setOnDropDownMenuListener(DropDownMenuListener listener) {
        this.mDropDownMenuListener = listener;
    }
}
