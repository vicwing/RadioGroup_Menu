package com.sunfusheng.StickyHeaderListView.view.TagContainerLayout;
...
//        fontH = fontMetrics.descent - fontMetrics.ascent;
        ...
        fontH = Math.abs(descent)+Math.abs(ascent);
//        Logger.d("leading "+leading +"  descent "+descent +"  ascent  "+ascent+"  fontH "+fontH);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measuredHeight = mVerticalPadding * 2 + (int) fontH;
        setMeasuredDimension(mHorizontalPadding * 2 + (int) fontW, measuredHeight);
//        Logger.d("tagview  "+" w "+getWidth()+"  h "+getHeight());
    }
